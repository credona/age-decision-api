...
@pytest.mark.parametrize(
    ...
    [
        ...
        {"core_raw_response": {"estimated_age": 17.4}},
        {"antispoof_raw_response": {"cred_antispoof_score": 0.91}},
...
def test_sanitize_log_payload_keeps_only_public_safe_context():
    payload = {
        ...
        "event": "api_verification_completed",
        "decision": "uncertain",
...
def test_runtime_logs_do_not_expose_sensitive_content(caplog):
    logger = logging.getLogger("age_decision.api.test")
